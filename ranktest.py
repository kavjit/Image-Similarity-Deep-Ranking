...
net.load_state_dict(torch.load('checkpoint2.ckpt'))
...
#train_embeddings = genfromtxt('train_embeddings.csv', delimiter = ',')
...
with torch.no_grad():
    for data in valloader:
        ...
        #print(norms_labels[0:10,0])
        #print(top30_list)
        #print('yolo {}'.format(i))
        if i == 40:
            break
        
np.savetxt('nlp.csv',nlp,delimiter = ',')
